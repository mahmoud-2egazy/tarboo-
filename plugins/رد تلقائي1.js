let handler = m => m 
 ...
 if (/^ببحبك بوت|حبك|بوت بحبك$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, ` انا اكتر ✨🥹💜 `, m) //wm, null, [['Menu', '#menu']], m) botones :V 
  
 } 
     
 if (/^🙂$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `متبصليش كدا🙂 `, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 ...
     conn.reply(m.chat, `اهلا`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
