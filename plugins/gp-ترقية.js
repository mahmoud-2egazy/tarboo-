...
if(!text && !m.quoted) return conn.reply(m.chat, `*[❗] الاستخدام المناسب*\n\n*┯┷*\n*┠≽ ${usedPrefix}ارفعو ادمن  @منشن*\n*┠≽ ${usedPrefix}ارفعو ادمن  -> الرد على رسالة*\n*┷┯*`, m)
...
conn.reply(m.chat, `*[ ✅ ] تم رفعه رول مبروك الادمن يحب ✨💜*`, m)
}}
handler.help = ['*201016948771xxx*','*@اسم المستخدم*','*محادثة المستجيب*'].map(v => 'promote ' + v)
handler.tags = ['group']
