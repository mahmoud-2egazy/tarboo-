let handler = m => m; 
 ...
   let responses; 
   if (/^بحبك| عاوزه اتجوزك|يتربو بحبك|بموت فيك|نتجوز|يبوت هنتجوز امتي| انت ليا| بموت فيك$/i.test(m.text)) { 
     responses = [ 
       'شكرا  ',  
       'هفكر في الموضوع',  
             'و انا',  
 ...
     ]; 
   }else if (/^عامل ايه|عامله ايه|عاملين ايه|الدنيا عامله ايه|عاملين ايه يشباب$/i.test(m.text)) { 
     responses = [ 
